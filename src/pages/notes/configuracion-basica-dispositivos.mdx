...
1.  [Acceso](/notes/configuracion-basica-dispositivos#acceso)
2.  [Hostname](/notes/configuracion-basica-dispositivos#hostname)
3.  [Contraseña consola](/notes/configuracion-basica-dispositivos#contraseña-consola)
4.  [Contraseña VTY](/notes/configuracion-basica-dispositivos#contraseña-vty)
5.  [Contraseña enable](/notes/configuracion-basica-dispositivos#contraseña-enable)
6.  [Encriptar contraseñas](/notes/configuracion-basica-dispositivos#encriptar-contraseñas)
7.  [Mensaje de aviso](/notes/configuracion-basica-dispositivos#mensaje-de-aviso)
8.  [Mostrar configuración](/notes/configuracion-basica-dispositivos#mostrar-configuración)
9.  [Guardar configuración](/notes/configuracion-basica-dispositivos#guardar-configuración)
