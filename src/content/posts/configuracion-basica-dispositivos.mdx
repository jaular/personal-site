...
2.  [Nombre de host](/blog/configuracion-basica-dispositivos#nombre-de-host)
...
5.  [Contraseña de usuario privilegiado](/blog/configuracion-basica-dispositivos#contraseña-de-usuario-privilegiado)
