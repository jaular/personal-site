...
4.  [Resultado](/blog/configuracion-enlaces-troncales#resultado)
...
| -------------------- | --------------- | -------------------- | --------------- |
| SW1                  | G0/1 <br/> G0/2 | SW2 <br/> SW3        | G0/1 <br/> G0/1 |
...
Utilice el comando `show vlan brief` para mostrar la lista de todas las VLAN configuradas.
...
Mostrar lista de todas las VLAN configuradas.
