...
> Recuerde configurar la [SVI](/blog/configuracion-interfaz-virtual-switch#svi) o agregar una [dirección IP](/blog/configuracion-interfaz-virtual-switch#direcci%C3%B3n-ip) al puerto que se esta utilizando.
