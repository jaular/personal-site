...
3.  [Traducción dinámica de direcciones aplicando PAT](/blog/ejercicio-acl-nat#traducción-dinámica-de-direcciones-aplicando-pat)
...
- Los usuario sy contraseñas para acceder por FTP son: cisco / cisco
...
## Traducción dinámica de direcciones aplicando PAT
