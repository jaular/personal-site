...
2.  [Dirección link-local](/blog/configuracion-ipv6#dirección-link-local)
3.  [Configuación manual de una dirección Link-Local](/blog/configuracion-ipv6#configuación-manual-de-una-dirección-link-local)
4.  [Verificar configuración](/blog/configuracion-ipv6#verificar-configuración)
